  ...
  return (
    <div className="overflow-hidden rounded-[28px] border border-white/40 bg-white/80 shadow-[0_20px_60px_rgba(59,130,246,0.15)] backdrop-blur-sm">
      <table className="min-w-full text-sm">
        <thead className="bg-gradient-to-r from-sky-100 via-cyan-50 to-violet-100 text-slate-700">
          <tr>
...
function StatCard({
  ...
  return (
    <motion.div
      ...
      className={`group relative flex h-[168px] w-full overflow-hidden rounded-[28px] border border-white/50 bg-gradient-to-br ${accent} p-5 text-left text-white shadow-[0_20px_70px_rgba(15,23,42,0.18)]`}
    >
...
function HeroInfoCard({
  ...
  return (
    <motion.div
      whileHover={{ y: -4, scale: 1.01 }}
      transition={{ type: "spring", stiffness: 260, damping: 18 }}
      className={`group relative overflow-hidden rounded-[28px] border border-white/50 bg-gradient-to-br ${accent} p-5 text-white shadow-[0_20px_70px_rgba(15,23,42,0.18)]`}
    >
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(255,255,255,0.35),transparent_35%)]" />
...
function PaginationControls({
  ...
  return (
    <div className="flex flex-col gap-3 border-t border-white/50 bg-gradient-to-r from-white/70 to-sky-50/70 px-6 py-4 sm:flex-row sm:items-center sm:justify-between">
    ...
    <motion.div layout initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.28 }}>
      <Card className="overflow-hidden rounded-[30px] border-white/40 bg-white/85 shadow-[0_14px_38px_rgba(14,116,144,0.10)] backdrop-blur-[2px] transition-shadow duration-200 hover:shadow-[0_18px_44px_rgba(99,102,241,0.14)]">
        <button
          type="button"
          onClick={onToggle}
          className="group flex w-full items-center justify-between gap-4 bg-gradient-to-r from-white/80 via-cyan-50/55 to-violet-50/55 px-6 py-5 text-left transition-colors duration-200 hover:from-sky-50/80 hover:via-cyan-50/60 hover:to-violet-50/70"
        >
          <div className="flex items-center gap-3">
            <div className="rounded-2xl bg-gradient-to-br from-sky-500 to-violet-500 p-2 text-white shadow-lg transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3">
        ...
        <div style={{ height: expanded ? contentHeight : 0 }} className="overflow-hidden transition-[height,opacity] duration-300 ease-out">
          <div ref={contentRef} className={`${expanded ? "opacity-100" : "opacity-0"} transition-opacity duration-200`}>
            <div className="border-t border-white/40 bg-gradient-to-b from-white/78 to-sky-50/30">
              ...
              <div className="overflow-x-auto border-y border-white/40">
                <table className="min-w-full text-sm">
                  <thead className="bg-gradient-to-r from-sky-100/90 via-cyan-50/85 to-violet-100/90 text-slate-700">
                    <tr>
                    ...
                    {visibleRows.length > 0 ? (
                      visibleRows.map((row, rowIndex) => (
                        <motion.tr key={`${table.name}-${startIndex + rowIndex}`} initial={false} className="border-t border-slate-200/50 align-top transition-colors hover:bg-sky-50/45">
                          ...
                          {table.columns.map((col) => (
                            <td key={col} className="max-w-[320px] break-words px-4 py-3 text-sm text-slate-700">
    ...
    <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.35 }}>
      <Card className="overflow-hidden rounded-[32px] border-white/50 bg-white/80 shadow-[0_30px_80px_rgba(59,130,246,0.16)] backdrop-blur-sm">
        <CardContent className="relative flex flex-col items-center justify-center gap-5 py-20 text-center">
          ...
          <div className="relative rounded-[28px] bg-gradient-to-br from-sky-500 via-cyan-500 to-violet-500 p-5 text-white shadow-2xl">
            {isUploading ? (
              <motion.div
            ...
            <Card className="rounded-[32px] border-white/50 bg-white/80 shadow-[0_25px_80px_rgba(59,130,246,0.14)] backdrop-blur-sm">
              <CardHeader>
                <div className="flex items-start gap-4">
                  <motion.div whileHover={{ rotate: 6, scale: 1.06 }} className="rounded-[24px] bg-gradient-to-br from-sky-500 to-violet-500 p-4 text-white shadow-xl">
              ...
              <CardContent className="space-y-5">
                <div className="flex flex-col gap-3 sm:flex-row">
                  <Button onClick={() => fileInputRef.current?.click()} disabled={isUploading} className="gap-2 rounded-2xl bg-gradient-to-r from-sky-500 to-violet-500 text-white shadow-lg transition hover:-translate-y-0.5 hover:from-sky-600 hover:to-violet-600 disabled:cursor-not-allowed disabled:opacity-90">
                    <motion.span
                    ...
                    {isUploading ? (
                      <div className="space-y-2">
                        ...
                        <div className="h-2 overflow-hidden rounded-full bg-white/80">
                          <motion.div className="h-full rounded-full bg-gradient-to-r from-sky-500 to-violet-500" animate={{ width: `${uploadProgress}%` }} transition={{ duration: 0.2, ease: "easeOut" }} />
                        </div>
                      </div>
                    ) : null}
                  </motion.div>
          ...
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.12, duration: 0.32 }}>
            <Card className="rounded-[32px] border-white/50 bg-white/80 shadow-[0_25px_80px_rgba(139,92,246,0.14)] backdrop-blur-sm">
              ...
              <CardContent className="space-y-4 text-sm text-slate-600">
                ...
                <div className="rounded-[24px] border border-violet-100 bg-gradient-to-br from-violet-50 to-fuchsia-50 p-4 shadow-sm">
                ...
                <div className="rounded-[24px] border border-emerald-100 bg-gradient-to-br from-emerald-50 to-teal-50 p-4 shadow-sm">
